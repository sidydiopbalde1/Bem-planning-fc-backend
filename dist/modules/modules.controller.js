...
let ModulesController = class ModulesController {
    ...
    findAll(pagination, programmeId, intervenantId, status) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Lister tous les modules' }),
    (0, swagger_1.ApiQuery)({ name: 'programmeId', required: false }),
    (0, swagger_1.ApiQuery)({ name: 'intervenantId', required: false }),
    (0, swagger_1.ApiQuery)({ name: 'status', required: false }),
    __param(0, (0, common_1.Query)()),
    __param(1, (0, common_1.Query)('programmeId')),
    __param(2, (0, common_1.Query)('intervenantId')),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, decorators_1.Roles)(roles_constant_1.Role.ADMIN, roles_constant_1.Role.COORDINATOR),
    (0, swagger_1.ApiOperation)({ summary: 'Obtenir un module' }),
...
__decorate([
    (0, common_1.Post)(),
    (0, decorators_1.Roles)(roles_constant_1.Role.ADMIN, roles_constant_1.Role.COORDINATOR),
    (0, swagger_1.ApiOperation)({ summary: 'Créer un module' }),
...
__decorate([
    ...
    (0, decorators_1.Roles)(roles_constant_1.Role.ADMIN, roles_constant_1.Role.COORDINATOR),
    (0, swagger_1.ApiOperation)({ summary: 'Supprimer un module' }),
    __param(0, (0, common_1.Param)('id')),
