...
export declare class StatisticsController {
    ...
    getStatistics(user: AuthenticatedUser, type?: string, startDate?: string, endDate?: string): Promise<{
        type: string;
        statistics: {
            totaux: {
                programmes: number;
    ...
    getGlobalStatistics(user: AuthenticatedUser): Promise<{
        type: string;
        statistics: {
            totaux: {
                programmes: number;
    ...
    getIntervenantsStatistics(user: AuthenticatedUser, startDate?: string, endDate?: string): Promise<{
        type: string;
        statistics: {
            intervenants: {
                id: string;
    ...
    getProgrammesStatistics(user: AuthenticatedUser): Promise<{
        type: string;
        statistics: {
            programmes: {
                id: string;
    ...
    getPlanningStatistics(user: AuthenticatedUser, startDate?: string, endDate?: string): Promise<{
        type: string;
        statistics: {
            periode: {
                debut: Date;
    ...
    getPerformanceIndicators(user: AuthenticatedUser): Promise<{
        type: string;
        statistics: {
            periode: {
                mois: string;
