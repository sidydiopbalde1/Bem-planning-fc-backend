...
export declare class IndicateursAcademiquesController {
    private readonly indicateursService;
    constructor(indicateursService: IndicateursAcademiquesService);
    ...
    partialUpdate(id: string, data: UpdateIndicateurAcademiqueDto): Promise<{
        programme: {
            id: string;
            name: string;
            code: string;
