...
export declare class CoordinateurService {
    private prisma;
    constructor(prisma: PrismaService);
    getProgrammes(userId: string, role: string, filters: {
        search?: string;
        status?: string;
        semestre?: string;
    }, pagination?: {
    ...
    getModules(userId: string, role: string, filters: {
        search?: string;
        status?: string;
        programmeId?: string;
    }, pagination?: {
    ...
    checkAlerts(userId: string, role: string): Promise<{
        programmesEnRetard: {
            count: number;
            items: {
                description: string | null;
