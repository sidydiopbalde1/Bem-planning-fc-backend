...
export declare class IntervenantsController {
    ...
    getMesSeances(user: AuthenticatedUser, status?: string, startDate?: string, endDate?: string): Promise<{
        seances: ({
            module: {
                programme: {
                    id: string;
    ...
    updateDisponibilite(id: string, disponible: boolean, user: AuthenticatedUser): Promise<{
        id: string;
        createdAt: Date;
        email: string;
        updatedAt: Date;
